    ...
    <section className="relative min-h-screen flex items-center justify-center bg-indian-pattern bg-cream-gradient overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <div className="animate-fade-in">
          {/* Badge */}
          <div className="inline-flex items-center space-x-2 bg-white/80 backdrop-blur-sm px-4 py-2 rounded-full border border-secondary/30 mb-6">
            <Star className="w-4 h-4 text-secondary fill-current" />
            <span className="text-sm font-medium text-brown">Trusted Since 1985</span>
          </div>
